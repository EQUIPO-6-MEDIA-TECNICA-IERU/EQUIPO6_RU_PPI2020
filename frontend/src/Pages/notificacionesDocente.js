                  ...
                  <div class="row">
                    <div class="col">
                      <div class="d-flex justify-content-center notificacion">
                        ...
                        />
                        <a class="letra text-center" href="/vistaAlerta">Se ha finalizado el reporte s2e3</a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col">
                    <div class="d-flex justify-content-center notificacion">
                      <img
                        ...
                        class="img-thumbnail imgc"
                      />
                      <a class="letra text-center" href="/vistaAlerta"> La docente Laura ha actualizado 
                        <br/> tu reporte</a>
                    </div>
                  </div>
                  ...
                  <div class="col">
                    <div class="d-flex justify-content-center notificacion">
                      <img
                        ...
                        class="img-thumbnail imgc"
                      />
                      <a class="letra text-center" href="/vistaAlerta">Tu reporte está activo actualmente
                         </a>
                    </div>
                  </div>
                </div>
